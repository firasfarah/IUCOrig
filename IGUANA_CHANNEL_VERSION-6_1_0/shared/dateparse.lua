...
-- Copyright (c) 2011 iNTERFACEWARE, Inc.
--
...
-- Convert a timestamp to a database timestamp.  Automatically detects
-- the input timestamp format, unless you specify one (fmt).
--
