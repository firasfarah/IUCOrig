-- This module is responsible for authenticating with the CRM and creating
--      the header for all interactions.
--      The code here has been adapted from the C# code found here:
...
-- Description: This function gets called from other modules to return the 
--              header and urn
-- Parameter(s): NONE. Note the username, password come from the conf file
-- Return(s):
--         - urnAddress: The CCP urn
--         - header: The header for all interactions with CCP
...
-- Description: This function gets the URL of the AD FS server
-- Parameter(s): 
--          - url: The url of the CRM
-- Return(s):
--          - adfsServer: The AD FS server URL
...
-- Description: Builds out an initial request and retrieve tokens 
--               and other stuff for authenticating
-- Parameter(s): 
--         - url: The url of the org 
--         - adfsUrl: The AD FS server URL
...
--         - x509IssuerName: The certificate issuer
--         - x509SerialNumber: Certificate serial number
--         - binarySecret: The binary secret 
...
-- Description: Builds out the SOAP header
-- Parameter(s): 
--         - url: The url of the org 
--         - token1: The first token
--         - token2: The second token
--         - keyId: The key identifier 
--         - issuerNameX509: The certificate issuer
--         - serialNumberX509: Certificate serial number
--         - signatureValue: hashed value of signature
--         - digestValue: hashed value of header timestamp
--         - created: time header was created
--         - expires: time header expires
-- Return(s):
--         - xmlStr: The header
