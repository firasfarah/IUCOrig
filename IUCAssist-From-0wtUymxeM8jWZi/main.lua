...
function insert(jsonTbl,conn) 
  ...
  -- local sqlStm = [[INSERT OR REPLACE INTO "webAPI" VALUES ('dev','localhost:6544','iucweb')]]
  --local sqlStm = [[INSERT OR REPLACE INTO "webAPI" VALUES ('prod','localhost:6544','iucweb2')]]
